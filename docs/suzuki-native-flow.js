...
function showRitual(){
 phase="heartbeat_intro";tapCount=0;const r=ensure();r.hidden=false;r.innerHTML=`<div class="szScene"><div class="szRitual"><div class="szDragon"><img class="szDragonImg" src="${EMBLEM}" alt="" decoding="async" fetchpriority="high"></div><div class="szText"></div><div class="szHint"></div></div></div><div class="szFlash"></div>`;bindDragonImage(r);
...
muteLegacy();window.CASuzukiSpecial={version:"native-detail-flow-dragon-image-20260924-1256",get phase(){return phase},reset:finish};
})();
