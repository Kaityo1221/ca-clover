...
if(/(?:^|\/)stamp-rally\.html$/.test(location.pathname)){const s=document.createElement("script");s.src="./suzuki-real-audio.js?v=20260923-2202";s.async=false;document.head.appendChild(s)}
})();
