...
if(/(?:^|\/)stamp-rally\.html$/.test(location.pathname)){
 const loadSuzuki=()=>{
  const s=document.createElement("script");s.src="./suzuki-real-audio.js?v=20260923-2306";s.async=false;s.onload=()=>{
   const f=document.createElement("script");f.src="./suzuki-vfx-layout-fix.js?v=20260923-2306";f.async=false;f.onload=()=>{
    const b=document.createElement("script");b.src="./suzuki-brush-cleanup.js?v=20260923-2306";b.async=false;document.head.appendChild(b)
   };document.head.appendChild(f)
  };document.head.appendChild(s)
 };
 const m=document.createElement("script");m.src="./suzuki-silence.js?v=20260923-2306";m.async=false;m.onload=loadSuzuki;m.onerror=loadSuzuki;document.head.appendChild(m)
}
})();