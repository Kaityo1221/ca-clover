...
if(/(?:^|\/)stamp-rally\.html$/.test(location.pathname)){const s=document.createElement("script");s.src="./suzuki-real-audio.js?v=20260923-2234";s.async=false;s.onload=()=>{const f=document.createElement("script");f.src="./suzuki-vfx-layout-fix.js?v=20260923-2234";f.async=false;document.head.appendChild(f)};document.head.appendChild(s)}
})();